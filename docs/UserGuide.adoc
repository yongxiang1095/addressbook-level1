...
Format: `add NAME d/DATE_OF_BIRTH p/PHONE_NUMBER e/EMAIL`

[NOTE]
====
Words in `UPPER_CASE` are the parameters. +
Phone number and email can be in any order but the name must come first, followed by the date of birth.
====

Examples:

* `add John Doe d/01.12.90 p/98765432 e/johnd@gmail.com`
* `add Betsy Crowe d/31.01.00 e/bencrowe@gmail.com p/1234567`
